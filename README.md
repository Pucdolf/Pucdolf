...
<h2>Hello World! I'm Jakub, a Computer Engineering Student 👋:</h2>
...
| Project | Description |
| :--- | :--- |
| [**🧛&nbsp;Dino&nbsp;Rush**](https://github.com/Pucdolf/EndlessRunner) | Endless runner game with random worlds and shop system.  |
| [**🧠&nbsp;IDPD**](https://github.com/Pucdolf/IntelligentDeskPresenceDetector) | Intelligent desk presence monitor with ESP32 and PIR sensor. |
| [**👁️&nbsp;Colorblindness&nbsp;Sim**](https://github.com/Pucdolf/ColorblindnessSimulator) | Real-time simulator for various types of color vision deficiency.  |
| [**💰&nbsp;Budget&nbsp;Manager**](https://github.com/Pucdolf/home-budget-manager) | Domestic budget tracking tool for income and expenses.  |
...
| [**🌡️&nbsp;Weather&nbsp;Station**](https://github.com/Pucdolf/WeatherStationEsp32) | Real-time IoT weather monitoring: C++ edge computing & .NET backend. |
</div>
